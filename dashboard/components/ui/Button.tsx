...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-signal text-abyss hover:brightness-110 disabled:brightness-75",
  secondary:
    "bg-panel2 text-mist border border-grid hover:border-haze",
  ghost:
    "bg-transparent text-haze hover:text-mist",
  danger:
